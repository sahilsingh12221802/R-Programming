...
#Use of Semicolon
.var1 <- 9;.var2<- 8 #Use is for multi line declaration

#Input From User
readline("My name: ") #output shown in console

nam <- readline("Enter your name: ") #output save din variable "nam"
class(nam)

as.integer(readline("Enter a number ")) #output should be integer
b <- as.numeric(readline("Enter a numeric number: ")) #output should be numeric
class(b)
